...
#         '''
#         генерирует n плоскостей способом way и возвращает плотность распределения
#         геометрических характеристик сечений: angles, areas, perimeter, a_semi, b_semi, minferet, maxferet, aspect, sphericity
#         '''
...
def calculate_all_distributions(polyhedron, way, PATH, type_figure='parallelepiped', n=10000, params=None):
        ...
        Если в папке PATH нет папки densities, то она создается, в ней сохранятся посчитанные распределения
        '''
